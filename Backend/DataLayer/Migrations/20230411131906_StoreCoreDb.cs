...
{
    /// <inheritdoc />
    public partial class StoreCoreDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RawCategories", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RawCategories_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawItemURL = table.Column<string>(type: "text", nullable: false),
                    RawCategoryId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RawItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RawItems_RawCategories_RawCategoryId",
                        column: x => x.RawCategoryId,
                        principalTable: "RawCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RawItemId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Items", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Items_RawItems_RawItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RawCategories_CategoryId",
                table: "RawCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_RawCategories_StoreId",
                table: "RawCategories",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_RawItems_RawCategoryId",
                table: "RawItems",
